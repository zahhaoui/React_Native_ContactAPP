      ...
      <View style={styles.container}>
          <View style={styles.header}>
            <View style={styles.headerContent}>
                ...
                <Text style={styles.name}>Khalil ElMalaki </Text>
                <Text style={styles.userInfo}>Khalilos@mail.com </Text>
                <Text style={styles.userInfo}>Marrakesh </Text>
            </View>
          </View>
          ...
          <View style={styles.body}>
            ...
            <View style={styles.item}>
              ...
              <View style={styles.infoContent}>
                <Text style={styles.info}>paramètre</Text>
              </View>
            </View>
            ...
            <View style={styles.item}>
              ...
              <View style={styles.infoContent}>
                <Text style={styles.info}>Memos</Text>
              </View>
            </View>
